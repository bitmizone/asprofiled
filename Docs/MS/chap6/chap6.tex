...
Do zalet tego rozwi¹zania mo¿na z pewnoœci¹ zaliczyæ nieinwazyjnoœæ kontraktów w stosunku do sprawdzanego kodu. Zestaw kontraktów mo¿e byæ zawarty w osobnej bibliotece, za³¹czanej w zale¿noœci od potrzeby. Z drugiej strony wymusza definiowanie klas jako publicznych, zaœ metody które maj¹ byæ przes³oniête musz¹ byæ oznaczone jako wirtualne - wynika to ze specyfiki koncepcji tworzenia dynamicznych obiektów poœrednicz¹cych.
