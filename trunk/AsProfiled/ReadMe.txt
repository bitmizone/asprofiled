========================================================================
    ACTIVE TEMPLATE LIBRARY : AsProfiled Project Overview
========================================================================

AppWizard has created this AsProfiled project for you to use as the starting point for
...
AsProfiled.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (AsProfiled.h)
        GUID definitions                                (AsProfiled_i.c)
        A type library                                  (AsProfiled.tlb)
        Marshaling code                                 (AsProfiled_p.c and dlldata.c)

AsProfiled.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in AsProfiled.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named AsProfiled.pch and a precompiled types file named StdAfx.obj.
...
AsProfiledps.vcproj
	...
	dlldata.c, AsProfiled_i.c and AsProfiled_p.c which are required
