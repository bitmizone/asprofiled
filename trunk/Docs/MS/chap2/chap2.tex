...
Fragment ten nie wymaga szerszego komentarza, warto jednak zwróciæ uwagê na s³owo kluczowe \emph{old} wykorzystane w warunkach koñcowych. Jego wyst¹pienie przed zmienn¹ oznacza odwo³anie do wartoœci pocz¹tkowej, czyli wartoœci na któr¹ wskazywa³a ta zmienna przed rozpoczêciem wykonywania metody. 
