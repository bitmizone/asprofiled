...
\lstset{showspaces=false, showstringspaces=false,showtabs=false, breaklines=true}
\begin{lstlisting}
...
argumentInfo - wska¿nik do struktury COR_PRF_FUNCTION_ARGUMENT_INFO, która okreœla po³o¿enie argumentów funkcji w pamiêci \\
retvalRange - wskaŸnik do struktury  COR_PRF_FUNCTION_ARGUMENT_RANGE, która okreœla po³o¿enie wyniku funkcji w pamiêci \\
