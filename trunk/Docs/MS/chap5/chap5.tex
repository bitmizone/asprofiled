...
Poni¿szy diagram ilustruje proces przetwarzania jakiemu poddawany jest kontrakt w celu oceny jego prawdziwoœci. Poszczególne elementy opisane s¹ w odpowiadaj¹cych im podrozdzia³ach.
\begin{figure}[h]
\centering
...
\begin{itemize}
\item iteruj¹ce po kolekcjach elementów zawieraj¹cych metadane na temat elementów powi¹zanych z dan¹ klas¹, metod¹, interfejsem, itp.,
...
Wyra¿enia okreœlaj¹ce kontrakt musz¹ byæ zbudowane zgodnie z regu³ami gramatyki przedstawionej w \ref{lst:Grammar} . Pierwszym krokiem na drodze do ich ewaluacji jest proces analizy leksykalnej. W tym celu wykorzystano silnik Astudillo Visual C++, który u¿ywa tablicy stanów wygenerowanych przez aplikacjê GOLD na podstawie zadanej gramatyki.
...
Maj¹c te dane do dyspozycji, biblioteka AsProfiled jest w stanie odczytaæ wartoœæ parametrów typu \emph{string}.
