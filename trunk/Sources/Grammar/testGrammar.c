...
char *Rule_Expression_Gt(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 3 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <Expression> ::= <Expression> '<' <Add Exp> */
char *Rule_Expression_Lt(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 3 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <Expression> ::= <Expression> '<=' <Add Exp> */
char *Rule_Expression_LtEq(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 3 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <Expression> ::= <Expression> '>=' <Add Exp> */
char *Rule_Expression_GtEq(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 3 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <Expression> ::= <Expression> '==' <Add Exp> */
char *Rule_Expression_EqEq(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 3 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <Expression> ::= <Expression> '<>' <Add Exp> */
char *Rule_Expression_LtGt(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 3 */
  struct TokenStruct *TokenArg;
  char *Value;
...
char *(*RuleJumpTable[])(struct TokenStruct *Token, int Debug, int Indent) = {
  ...
  /* 1. <Expression> ::= <Expression> '>' <Add Exp> */
  Rule_Expression_Gt,

  /* 2. <Expression> ::= <Expression> '<' <Add Exp> */
  Rule_Expression_Lt,

  /* 3. <Expression> ::= <Expression> '<=' <Add Exp> */
  Rule_Expression_LtEq,

  /* 4. <Expression> ::= <Expression> '>=' <Add Exp> */
  Rule_Expression_GtEq,

  /* 5. <Expression> ::= <Expression> '==' <Add Exp> */
  Rule_Expression_EqEq,

  /* 6. <Expression> ::= <Expression> '<>' <Add Exp> */
  Rule_Expression_LtGt,

  /* 7. <Expression> ::= <Add Exp> */
  Rule_Expression,

  /* 8. <Add Exp> ::= <Add Exp> '+' <Mult Exp> */
  Rule_AddExp_Plus,

  /* 9. <Add Exp> ::= <Add Exp> '-' <Mult Exp> */
  Rule_AddExp_Minus,

  /* 10. <Add Exp> ::= <Mult Exp> */
  Rule_AddExp,

  /* 11. <Mult Exp> ::= <Mult Exp> '*' <Negate Exp> */
  Rule_MultExp_Times,

  /* 12. <Mult Exp> ::= <Mult Exp> '/' <Negate Exp> */
  Rule_MultExp_Div,

  /* 13. <Mult Exp> ::= <Negate Exp> */
  Rule_MultExp,
